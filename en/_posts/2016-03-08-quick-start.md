...
If you have already setup a lab, this procedure should be easy for you. 
 ...
 - On this page, you have only one action available : create credentials. You can then have a username in the following form : ra-logs-XXXXX. this username will be the one you will have to use on Graylog and with Kibana later (you will know soon enough how to do it). 
...
PaaS Logs supports several logs formats, each one of them has its own advantages and incovenients: 

 - Gelf : This is the native format of logs used by Graylog. This JSON format will allow you to send logs really easily. See: http://docs.graylog.org/en/latest/pages/gelf.html.
 - LTSV: this simple format is very efficient and is still human readable. you can learn more about it [here](ltsv.org)
 ...
 - Capn'Proto : The most efficient log format. this is a binary format that will allows you to maintain a low footprint and high speed performance. If you want to know more about it, check the official website : [Cap'n'Proto](https://capnproto.org/)

To send your logs to PaaS Logs we can use echo and openssl. Here is 3 examples, choose the format you like the most with your preffered terminal : 
...
We have only scratched the surface of what PaaS Logs can do for you. you will find soon enough how to : 
  ...
  - If you want to master the Graylog, this is the place to go : [Graylog documentation](http://docs.graylog.org/en/1.3/pages/queries.html)
